...
# Apply to original dataset, but remember to keep activity and subject columns (562 & 563)
Compiled_higherdata <- Compiled_higherdata[,c(vars_indices_keep, 562, 563)]

# Change the tests from numbers to descriptive factors. Use ifelse statements.
Compiled_higherdata$Activity <- 
